<template>
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    <div class="px-6 pt-6 pb-5 font-bold border-b border-gray-200">
      <span class="card-title">{{ $t("song.Upload") }}</span>
      <label>
        <i class="fas fa-upload float-right text-green-400 text-2xl cursor-pointer"></i>
    ...
    <div class="p-6">
      ...
      <div
        ...
        <h5>{{ $t("song.drop-files-here") }}</h5>
      </div>

      <!-- <hr class="my-6" /> -->
      <!-- Progess Bars -->
      <div class="mb-4 mt-2" v-for="upload in uploads" :key="upload.name">
        <!-- File Name -->
